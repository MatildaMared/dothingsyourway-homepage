  ...
  return (
      <Section className="about">
          ...
          <AboutWrapper>
              ...
              <AboutText>
                  <p>
                      Min formella utbildning består av två kandidatexamen från
                      Göteborgs Universitet, en i psykologi och en i
                      personalvetenskap. I över 5 år har jag dessutom konsumerat
                      hundratals böcker och föreläsningar av vår tids största
                      tänkare inom personlig utveckling. Jag har även jobbat som
                      affärssystemutvecklare där jag hjälpt mindre företag med
                  ...
                  <p>
                      Jag älskar att utbilda och coacha mina kunder i hur de tar
                      nästa steg i sin utveckling, det är min stora passion i
                      livet. Jag ser verkligen fram emot att ha med dig i
                      programmet!
                  </p>
              </AboutText>
          </AboutWrapper>
